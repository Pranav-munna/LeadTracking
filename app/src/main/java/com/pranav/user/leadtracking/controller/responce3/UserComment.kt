...
@JsonPropertyOrder("id", "first_name", "last_name", "about", "email", "designation_id", "profile_image", "role_id", "is_enabled", "location", "contact_number", "office_number", "oid", "systemid", "access_in_dynamics", "created_at", "updated_at")
class UserComment {
