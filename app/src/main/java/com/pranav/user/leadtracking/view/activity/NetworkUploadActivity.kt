...
import com.pranav.user.leadtracking.view.fragment.NetworkUploadFragment

class NetworkUploadActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState==null){
            supportFragmentManager.beginTransaction()
                    .add(R.id.idMain, NetworkUploadFragment(),"NetworkUploadActivity")
                    .commit()
        }
    }
