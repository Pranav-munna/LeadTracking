...
class RvGridMultiSelectAnswerAdapter(var context: Context) : RecyclerView.Adapter<RvGridMultiSelectAnswerAdapter.ViewHolder>() {
    ...
    fun setCallBack(rvAllQuestionAdapter: RvAllQuestionAdapter) {
        cardViewCallBackSelect = rvAllQuestionAdapter
